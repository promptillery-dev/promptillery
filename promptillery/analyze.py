...
# Regret figure -- one row per (dataset, selector, volume).
REGRET_CURVE_FIELDS = [
    "dataset",
    "selector",
    "volume",
...
def summarize_run(
    ...
    return {
        ...
        "final_teacher_fidelity": _safe_float(
            final_cycle_metrics.get("teacher_fidelity")
        ),
        "heldout_teacher_fidelity": _safe_float(
            heldout.get("teacher_fidelity") if heldout else None
        ),
...
def write_summary_csv(rows: List[Dict[str, Any]], output_path: Path) -> None:
    ...
    fieldnames = [
        ...
        "final_teacher_fidelity",
        "heldout_teacher_fidelity",
        "cycle_quality_cost_auc",
...
def summarize_paper_main_results(
    ...
    for key, group in sorted(
        ...
        estimated_cost_mean, estimated_cost_std = _mean_std(
            row.get("estimated_cost") for row in group
        )
        ...
        results.append(
            {
                ...
                "std_estimated_cost": estimated_cost_std,
